...
### 2. [TENCENT_CLOUD_DEPLOYMENT.md](./TENCENT_CLOUD_DEPLOYMENT.md) - 腾讯云部署指南 ⭐⭐⭐⭐⭐
**腾讯云用户必读**，包含完整的服务器配置、OCR服务配置、应用部署步骤。
...
**开发者必读**，包含所有API接口的完整参考、使用示例、错误处理。
...
### 29. [QUICK_REFERENCE.md](./QUICK_REFERENCE.md)
快速参考手册。
...
3. [DEPLOYMENT.md](./DEPLOYMENT.md) - 通用部署
