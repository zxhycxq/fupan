            ...
            <Row gutter={[16, 8]}>
              ...
              <Col xs={24} sm={12} md={12} lg={7}>
                <Form.Item 
                  ...
                  name="dateRange" 
                  className="mb-2"
                  labelCol={{ xs: 24, sm: 8, md: 4, lg: 5 }}
                  wrapperCol={{ xs: 24, sm: 16, md: 20, lg: 19 }}
                >
                  <DateRangeFilter 
                    value={dateRange} 
                    onChange={(dates) => {
              ...
              <Col xs={24} sm={24} md={6} lg={13} className="flex items-end justify-end lg:-mt-2">
