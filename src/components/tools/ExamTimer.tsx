...
export default function ExamTimer() {
    ...
    const [showVipModal, setShowVipModal] = useState(false); // VIP 提示弹窗
    const [showVipBenefits, setShowVipBenefits] = useState(false); // VIP 购买弹窗
        ...
        <div className="space-y-6">
            ...
            >
                <div className="text-center py-8 space-y-6">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-2xl font-bold">考试报告功能</h2>
                        <p className="text-gray-600">
                            该功能为 VIP 会员专享功能
                        </p>
                    </div>

                    <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-6 space-y-4">
                        ...
                        <ul className="text-left space-y-3 text-gray-700">
                            <li className="flex items-start gap-2">
                                ...
                                <span>查看详细的考试报告和数据分析</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-green-500 mt-1">✓</span>
                                <span>导出 Excel 格式的考试数据</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-green-500 mt-1">✓</span>
                                <span>自定义主题肤色和等级称谓</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-green-500 mt-1">✓</span>
                                <span>无限制保存考试记录</span>
                    ...
                    <div className="flex gap-3 justify-center">
                        <Button size="large" onClick={() => setShowVipModal(false)}>
                            稍后再说
                        </Button>
                        <Button
                            type="primary"
                            ...
                            className="bg-gradient-to-r from-yellow-500 to-yellow-600 border-0"
                        >
                            立即开通 VIP
                        </Button>
                    </div>
            ...
            {/* VIP 购买弹窗组件 */}
            <VipBenefitsModal
                open={showVipBenefits}
                onClose={() => setShowVipBenefits(false)}
                currentFeature="exam_report"
            />
        </div>
    );
}
